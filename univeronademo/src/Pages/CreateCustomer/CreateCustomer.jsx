...
import { FaCheckCircle, FaPaperclip, FaTimes, FaExclamationTriangle } from 'react-icons/fa';
...
function CreateCustomer() {
  ...
  useEffect(() => {
    ...
    fetch('https://sdsinfotech.co.in/api/common/countries', { headers }).then(res => res.json()).then(res => res.data && setCountriesList(res.data)).catch(err => console.error("Countries fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/currencies', { headers }).then(res => res.json()).then(res => res.data && setCurrenciesList(res.data)).catch(err => console.error("Currencies fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/industries', { headers }).then(res => res.json()).then(res => res.data && setIndustriesList(res.data)).catch(err => console.error("Industries fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/payment-terms', { headers }).then(res => res.json()).then(res => res.data && setPaymentTermsList(res.data)).catch(err => console.error("Payment Terms fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/payment-methods', { headers }).then(res => res.json()).then(res => res.data && setPaymentMethodsList(res.data)).catch(err => console.error("Payment Methods fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/customer-types', { headers }).then(res => res.json()).then(res => res.data && setCustomerTypesList(res.data)).catch(err => console.error("Customer Types fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/bank-account-types', { headers }).then(res => res.json()).then(res => res.data && setBankAccountTypesList(res.data)).catch(err => console.error("Bank Account Types fetch error:", err));
    fetch('https://sdsinfotech.co.in/api/common/shipping-methods', { headers }).then(res => res.json()).then(res => res.data && setShippingMethodsList(res.data)).catch(err => console.error("Shipping Methods fetch error:", err));
  }, [activeToken]);
      ...
      const fetchCustomerData = async () => {
        ...
        try {
          ...
          if (result.statusCode === 200 && result.data) {
            ...
            setFormData(prev => ({
              ...prev,
              type: data.type ? data.type.toString() : data.customer_type?.id ? data.customer_type.id.toString() : "",
        ...
        <div className="cust-glass-card">
          ...
          <div className="cust-form-grid">
            ...
            <div className="cust-input-group">
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} maxLength={50} placeholder="Legal Corporate Name" />
            </div>
